...
export const API_PHONE_NUM_CHECK = API_HOST + "/api/user/phoneNumCheck";

export const API_JOIN = API_HOST + "/api/user/join";

export const API_DELETE_USER = API_HOST + "/api/user/deleteUser";